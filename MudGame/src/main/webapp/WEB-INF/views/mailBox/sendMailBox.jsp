    ...
    <div id="wrap">
        ...
        <section class="main">
			...
			<div class="mainCenter">
					...
					<h2 class="sendMailBoxTitle">보낸 우편함</h2>
				<div class="mailTitle">
					<span>우편은 최대 15개까지만 표시 가능합니다.</span>
					<button class="writeMail" onclick="writeMailShow()">우편 쓰기</button>
				</div>
				<div class="mailList">
					
					<c:if test="${sendMail[0] != null && sendMail[0].sendId == session.getId()}">
						<ul>
							<li>받는사람</li>
							<li>제목</li>
							<li>보낸 시각</li>
						...
						<c:forEach var="mailList" items="${sendMail}">				
							<ul onclick="sendMailDetail(${mailList.mailNo})">
								<li>${mailList.receiveId}</li>
